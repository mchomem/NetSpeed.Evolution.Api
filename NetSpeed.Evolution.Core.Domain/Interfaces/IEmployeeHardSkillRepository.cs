...
public interface IEmployeeHardSkillRepository
{
    ...
    public Task<EmployeeHardSkill> GetAsync(Expression<Func<EmployeeHardSkill, bool>> filter, IEnumerable<string>? includes = null);
    public Task<IEnumerable<EmployeeHardSkill>> GetAllAsync(Expression<Func<EmployeeHardSkill, bool>> filter, IEnumerable<string>? includes = null);
